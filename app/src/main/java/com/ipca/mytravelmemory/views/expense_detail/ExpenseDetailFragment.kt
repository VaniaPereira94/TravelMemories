package com.ipca.mytravelmemory.views.expense_detail
...
import com.ipca.mytravelmemory.databinding.FragmentExpenseDetailBinding
...
class ExpenseDetailFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            expense =
                it.getSerializable(ExpenseDetailFragment.EXTRA_EXPENSE_DETAILS) as ExpenseModel
        }
    }
