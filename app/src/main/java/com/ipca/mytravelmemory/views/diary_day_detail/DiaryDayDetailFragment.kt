...
import com.ipca.mytravelmemory.databinding.FragmentDiaryDayDetailBinding
...
class DiaryDayDetailFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            diaryDay =
                it.getSerializable(DiaryDayDetailFragment.EXTRA_DIARY_DAY_DETAILS) as DiaryDayModel
        }
    }
